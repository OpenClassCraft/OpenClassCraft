...
void set_default_settings()
{
	...
	settings->setDefault("font_path", porting::getDataPath("fonts" DIR_DELIM "NotoSans-Regular.ttf"));
	settings->setDefault("font_path_italic", porting::getDataPath("fonts" DIR_DELIM "NotoSans-Italic.ttf"));
	settings->setDefault("font_path_bold", porting::getDataPath("fonts" DIR_DELIM "NotoSans-Bold.ttf"));
	settings->setDefault("font_path_bold_italic", porting::getDataPath("fonts" DIR_DELIM "NotoSans-BoldItalic.ttf"));
	...
	settings->setDefault("fallback_font_path", porting::getDataPath("fonts" DIR_DELIM "NotoSansMalayalam-Variable.ttf"));
	settings->setDefault("secondary_fallback_font_path", porting::getDataPath("fonts" DIR_DELIM "DroidSansFallbackFull.ttf"));
	...
	settings->setDefault("enable_lan_discovery", "true");
