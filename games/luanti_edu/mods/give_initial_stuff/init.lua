...
local STARTER_ITEMS = {
	...
	"openclasscraft_ecology:spawn_squirrel",
	"openclasscraft_ecology:spawn_duck",
	"openclasscraft_ecology:spawn_cow",
	"openclasscraft_ecology:spawn_chicken",
	"openclasscraft_ecology:spawn_dog",
	"openclasscraft_ecology:spawn_cat",
