...
Wildlife uses lightweight rigged models with distinct world sizes: rabbits are compact, foxes are medium-sized, and deer stand clearly taller than both. Rabbits hop, deer can graze, foxes trot, and all three blend between idle, walking, running, and resting poses. Wild animals notice nearby players: rabbits and deer retreat, foxes keep a cautious distance, and a held Companion Treat attracts rabbits and foxes. Movement accelerates and turns smoothly, avoids unsafe drops, steps or jumps over small obstacles, and lets distant companions safely catch up with their owner without crowding other players.
